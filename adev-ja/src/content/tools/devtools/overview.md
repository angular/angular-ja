...
| [Router Tree](tools/devtools/router)      | アプリケーションのルーティングツリーを視覚化できます。                                                              |

`Transfer State`などの他のタブは実験的であり、DevToolsの設定から有効にできますが、まだドキュメント化されていません。
