...
Angular `コア` ライブラリに1つ以上の *ライフサイクルフック* インターフェースを実装することで、コンポーネントまたはディレクティブのライフサイクルのイベントに応答できます。
...
<table width="100%">
  ...
  <tr style='vertical-align:top'>
    ...
    <td>
      ...
      [ビュー](guide/glossary#view "Definition of view.") による Angular の手段を示します。
