...
この時点までで、ユーザーは商品情報を表示し、共有をシミュレートして商品の変更について通知を受けることができます。 しかし、ユーザーは商品を買うことはできません。
...
1. 新しい "Buy" ボタンを表示するには、アプリケーションを更新して商品の名前をクリックして詳細を表示します。
...
カートページを作成するには、商品詳細コンポーネントを作成し、新しいコンポーネントのルーティングを設定したのと同じ手順を実行します。
