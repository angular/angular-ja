...
[シグナルの作成と更新方法](/tutorials/signals/1-creating-your-first-signal)を学んだところで、算出シグナルについて学びましょう。算出シグナルは、依存関係が変更されると自動的に更新される派生値です。他のシグナルに基づいてリアクティブな計算を作成するのに最適です。
